...
if [ -d "$PATCHES_DIR" ]; then
    for patch in 01-bool-stdbool.patch 02-nolic-sharding.patch 03-atomic128-x86.patch 04-gtm-thread-bind.patch 06-ctl-tempfile-portcheck.patch 07-forward-dn-reconnect.patch 08-ctl-forward-port-persistence.patch; do
